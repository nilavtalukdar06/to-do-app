  ...
  return (
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
      ...
      <td className="px-6 py-4 flex gap-2">
        ...
        {!status && (
          <button
            className="py-2 px-4 bg-green-500 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 ease-in-out cursor-pointer"
            onClick={() => completeTask(dbId)}
          >
            Done
          </button>
        )}
